            ...
            <div className="px-6 mt-4 mb-9 flex flex-col md:flex-row md:items-end gap-8">
                ...
                <div>
                    ...
                    <h2 className="text-white text-5xl font-extrabold mb-4 md:text-6xl tracking-tight">
                        {playlistData[0]?.ten_playlist || 'Playlist của bạn #1'}
                    </h2>
                    ...
                    <p className="text-[#b3b3b3] mt-1 font-medium text-[14px]">
                        ...
                        <b className="text-white text-[14px]"> Spotify </b>• {playlistData.length} bài hát , khoảng 3
                        giờ 30 phút
                    </p>
                </div>
            </div>
                        ...
                        render={(attrs) => (
                            ...
                            >
                                {target ? (
                                    ...
                                    <span>Các tùy chọn khác cho {playlistData[0]?.ten_playlist || 'Playlist'}</span>
                                )}
                            </div>
                        )}
                    >
